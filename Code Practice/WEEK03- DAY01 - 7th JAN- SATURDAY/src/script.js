...
const Cards = ({ cardData }) => {
  ...
  return (
    <div className="w-48 shadow-lg rounded-md p-2">
  ...
  return (
    <React.Fragment>
      ...
      <div className="max-w-6xl mx-auto grid gap-5 grid-cols-4 grid-rows-3">
        <Cards cardData={mealsData.meals[0]} />
        <Cards cardData={mealsData.meals[1]} />
        <Cards cardData={mealsData.meals[2]} />
        <Cards cardData={mealsData.meals[3]} />
        <Cards cardData={mealsData.meals[4]} />
        <Cards cardData={mealsData.meals[5]} />
        <Cards cardData={mealsData.meals[6]} />
        <Cards cardData={mealsData.meals[7]} />
        <Cards cardData={mealsData.meals[8]} />
        <Cards cardData={mealsData.meals[9]} />
        <Cards cardData={mealsData.meals[10]} />
        <Cards cardData={mealsData.meals[11]} />
      </div>
    </React.Fragment>
  );
};
